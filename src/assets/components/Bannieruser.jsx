  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4 text-center">
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-4 border-brand px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
          ...
          <p className="leading-relaxed">Solutions agrées</p>
        </div>
      </div>
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-4 border-brand px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-4 border-brand px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
          ...
          <p className="leading-relaxed">Clients fidéles</p>
        </div>
      </div>
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-4 border-brand px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
